...
description: "무릎 연골은 한번 닳으면 스스로 채워지지 않습니다. 2025년 검토 논문에 따르면 운동치료는 연골 구조를 해치지 않는 것으로 확인됐습니다. 닳은 정도와 통증이 비례하지 않는 이유와 할 수 있는 것을 정리했습니다."
...
![연령대별 무릎관절증 환자 수](/images/posts/knee-cartilage-wear-truth/16-age.png)

건강보험심사평가원 2025년 자료에서 무릎관절증 관련 상병으로 진료받은 규모입니다.
...
**40대에서 50대로 넘어가며 3.4배, 50대에서 60대로 넘어가며 2.3배가 됩니다.**

성별 차이도 큽니다. 60대에서 여성 환자가 남성의 2.5배 정도입니다.

*(세 가지 상병 코드를 합산한 수치이며, 같은 사람이 여러 코드로 진료받은 경우가 포함될 수 있어 실제 환자 수는 이보다 적을 수 있습니다.)*
